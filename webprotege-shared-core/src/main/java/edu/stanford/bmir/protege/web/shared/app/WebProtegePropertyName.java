...
public enum WebProtegePropertyName {
    ...
    @WebProtegePropertiesDocumentation(description = "The time in milliseconds after which a project becomes dormant and is purgable from memory", example = "3600000")
